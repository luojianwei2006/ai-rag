...
var Vue = require('vue');
var index = require('../../_chunks/dep-50d2328a.js');
...
var _baseUniq = require('../../_chunks/dep-84b9a856.js');
...
var useSelectOptions = function useSelectOptions(props, keys, inputValue, innerValue) {
  ...
  var searchDisplayOptions = Vue.computed(function () {
    ...
    searchOptions.value = uniqBy([].concat(_toConsumableArray__default["default"](currentSelectedOptions), _toConsumableArray__default["default"](searchOptions.value)), "value");
