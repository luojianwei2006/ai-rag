...
var index = require('../_chunks/dep-d522f199.js');
...
var isFunction = require('../_chunks/dep-f4e9436d.js');
var isArray = require('../_chunks/dep-ac99965c.js');
var _baseIteratee = require('../_chunks/dep-761e41bd.js');
var omit = require('../_chunks/dep-7325f3b1.js');
var _isIndex = require('../_chunks/dep-054cd750.js');
...
var handleRange = function handleRange(range) {
  ...
  var fallback = function fallback(edge) {
    var fallbackParsed = dayjs__default["default"](MIN_YEAR);
    if (edge === "to") {
...
var _Calendar = Vue.defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var rangeFromTo = Vue.computed(function () {
      return handleRange(props2.range);
    });
    ...
    var dateSelect = {
      yearSelectOptionList: Vue.computed(function () {
        ...
        if (begin < calendar_constants_index.MIN_YEAR) {
          begin = calendar_constants_index.MIN_YEAR;
        }
        if (end < calendar_constants_index.MIN_YEAR) {
          end = calendar_constants_index.MIN_YEAR;
        }
      ...
      monthSelectOptionList: Vue.computed(function () {
        adjustMonth();
        var re = [];
        for (var i = calendar_constants_index.FIRST_MONTH_OF_YEAR; i <= calendar_constants_index.LAST_MONTH_OF_YEAR; i++) {
    ...
    var yearCellsData = Vue.computed(function () {
      ...
      var rowCount = Math.ceil(monthsArr.length / calendar_constants_index.DEFAULT_YEAR_CELL_NUMINROW);
      var index = 0;
      for (var i = 1; i <= rowCount; i++) {
        var row = [];
        for (var j = 1; j <= calendar_constants_index.DEFAULT_YEAR_CELL_NUMINROW; j++) {
