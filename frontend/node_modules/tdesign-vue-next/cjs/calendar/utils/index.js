...
var getDayCn = function getDayCn(num) {
  ...
  if (numStr in calendar_constants_index.DAY_CN_MAP) {
    re = calendar_constants_index.DAY_CN_MAP[numStr];
  }
  return re;
};
...
var createYearCellsData = function createYearCellsData(props, state) {
  ...
  for (var num = calendar_constants_index.FIRST_MONTH_OF_YEAR; num <= calendar_constants_index.LAST_MONTH_OF_YEAR; num++) {
    _loop(num);
  }
  return monthsArr;
};
