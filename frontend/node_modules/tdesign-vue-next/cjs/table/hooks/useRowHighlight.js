...
var common = require('../../_chunks/dep-78278555.js');
...
function useRowHighlight(props, tableRef) {
  ...
  var handleInactive = function handleInactive(ctx) {
    ...
    if (activeRowType.value === "single") {
      ...
      var _activeRowList = [];
      for (var _i = 0, _len = data.value.length; _i < _len; _i++) {
        var _row = data.value[_i];
        if (_newActiveRowKeys.includes(get.get(_row, props.rowKey))) {
          _activeRowList.push({
            row: _row,
            rowIndex: _i
          });
