...
var renderTnode = require('../_chunks/dep-c0f98bf1.js');
var index$1 = require('../_chunks/dep-d522f199.js');
var index = require('../_chunks/dep-4212631b.js');
var index$2 = require('../_chunks/dep-3ff65181.js');
var index$4 = require('../_chunks/dep-31b1e4d7.js');
var loading_loading = require('../_chunks/dep-182ccba7.js');
var index$3 = require('../_chunks/dep-721bc27c.js');
var isArray = require('../_chunks/dep-ac99965c.js');
var isString = require('../_chunks/dep-1ad2ac36.js');
...
var imageViewer_constants_index = require('./constants/index.js');
...
var isNumber = require('../_chunks/dep-8e6a1720.js');
...
require('../_chunks/dep-f201a161.js');
...
var _ImageViewer = Vue.defineComponent({
  ...
  setup: function setup(props2) {
    ...
    var zIndexValue = Vue.computed(function () {
      var _props2$zIndex;
      return (_props2$zIndex = props2.zIndex) !== null && _props2$zIndex !== void 0 ? _props2$zIndex : 3e3;
    });
    ...
    var keydownHandler = function keydownHandler(e) {
      e.stopPropagation();
      switch (e.code) {
        case imageViewer_constants_index.EVENT_CODE.left:
          prevImage();
          break;
        case imageViewer_constants_index.EVENT_CODE.right:
          nextImage();
          break;
        case imageViewer_constants_index.EVENT_CODE.up:
          onZoomIn();
          break;
        case imageViewer_constants_index.EVENT_CODE.down:
          onZoomOut();
          break;
        case imageViewer_constants_index.EVENT_CODE.esc:
    ...
    var renderTitle = function renderTitle() {
      ...
      }, [titleContent ? titleContent : "".concat(indexValue.value + 1, "/").concat(images.value.length)]);
    };
    ...
    return function () {
      if (props2.mode === "modeless") {
        return Vue.createVNode(Vue.Fragment, null, [renderTnode.isPropsUsed("trigger") ? renderTNodeJSX("trigger", {
          params: {
            open: openHandler
          }
        ...
        "default": function _default() {
          return [Vue.createVNode(Vue.Transition, null, {
            "default": function _default() {
              ...
              }, null), images.value.length > 1 && Vue.createVNode(Vue.Fragment, null, [renderHeader(), renderTitle(), renderNavigationArrow("prev"), renderNavigationArrow("next")]), renderCloseBtn(), Vue.createVNode(imageViewer_base_ImageViewerUtils["default"], {
