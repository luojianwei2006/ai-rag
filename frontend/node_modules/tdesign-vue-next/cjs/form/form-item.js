...
var form_constants_index = require('./constants/index.js');
require('@babel/runtime/helpers/toConsumableArray');
require('@babel/runtime/helpers/typeof');
require('../_chunks/dep-5de13842.js');
var index = require('../_chunks/dep-d522f199.js');
var index$2 = require('../_chunks/dep-4212631b.js');
...
var _FormItem = Vue.defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var CLASS_NAMES = form_constants_index.useCLASSNAMES();
    ...
    var form = Vue.inject(form_constants_index.FormInjectionKey, void 0);
    ...
    var getDefaultIcon = function getDefaultIcon() {
      ...
      if (verifyStatus.value === form_constants_index.ValidateStatus.SUCCESS) {
    ...
    var verifyStatus = Vue.ref(form_constants_index.ValidateStatus.TO_BE_VALIDATED);
    ...
    var resetHandler = function resetHandler() {
      ...
      errorList.value = [];
      successList.value = [];
      verifyStatus.value = form_constants_index.ValidateStatus.TO_BE_VALIDATED;
    };
          ...
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 1:
              ...
              return form_utils_formModel.validate(value.value, result.rules, {
                formData: form === null || form === void 0 ? void 0 : form.data,
                name: props2.name
              });
            case 2:
        ...
        return _regeneratorRuntime__default["default"].wrap(function (_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 1:
              ...
              if (rules.length) {
                verifyStatus.value = innerErrorList.length ? form_constants_index.ValidateStatus.FAIL : form_constants_index.ValidateStatus.SUCCESS;
              }
    ...
    var setValidateMessage = function setValidateMessage(validateMessage) {
      ...
      if (validateMessage.length === 0) {
        verifyStatus.value = form_constants_index.ValidateStatus.SUCCESS;
        return;
      }
      ...
      verifyStatus.value = errors.length > 0 ? form_constants_index.ValidateStatus.FAIL : form_constants_index.ValidateStatus.SUCCESS;
    };
    ...
    Vue.provide(form_constants_index.FormItemInjectionKey, {
