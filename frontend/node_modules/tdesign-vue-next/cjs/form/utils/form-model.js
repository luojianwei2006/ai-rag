...
var _commonjsHelpers = require('../../_chunks/dep-a3769001.js');
...
var VALIDATE_MAP = {
  ...
  validator: function validator(val, validate2, context) {
    return validate2(val, context);
  }
};
function validateOneRule(_x, _x2, _x3) {
  return _validateOneRule.apply(this, arguments);
}
function _validateOneRule() {
  _validateOneRule = _asyncToGenerator__default["default"](/*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee(value, rule, context) {
    ...
    return _regeneratorRuntime__default["default"].wrap(function (_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          _context.next = 5;
          return vValidateFun(value, vOptions, context);
        case 5:
...
function _validate() {
  _validate = _asyncToGenerator__default["default"](/*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee2(value, rules, context) {
    var all, r;
    return _regeneratorRuntime__default["default"].wrap(function (_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          all = rules.map(function (rule) {
            return validateOneRule(value, rule, context);
          });
          _context2.next = 1;
