...
var _SwiperItem = Vue.defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var translateX = Vue.computed(function () {
      if (props2.type !== "card") return 0;
      var swiperWidth = props2.swiperWidth;
      ...
      if (inStage) {
        return swiperWidth * ((translateIndex - props2.currentIndex) * (1 - itemWidth * props2.cardScale) - itemWidth + 1) / 2;
      }
      if (translateIndex < props2.currentIndex) {
        return -itemWidth * (1 + props2.cardScale) * swiperWidth / 2;
      }
      return (2 + itemWidth * (props2.cardScale - 1)) * swiperWidth / 2;
    });
