...
var _PrimaryTable = defineComponent({
  ...
  setup: function setup(props, context) {
    ...
    var _useEditableRow = useRowEdit(props),
      ...
      clearValidateRowData = _useEditableRow.clearValidateRowData,
      clearAllEditableCellData = _useEditableRow.clearAllEditableCellData,
      onCellInstanceChange = _useEditableRow.onCellInstanceChange,
      ...
      var _loop = function _loop() {
        ...
        if ((_item$edit = item.edit) !== null && _item$edit !== void 0 && _item$edit.component) {
          ...
          item.cell = function (h2, p) {
            ...
            var cellKey = getCellKey(p.row, props.rowKey || "id", p.col.colKey, p.colIndex);
