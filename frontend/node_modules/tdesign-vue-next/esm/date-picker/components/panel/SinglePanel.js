...
var TSinglePanel = defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    return function () {
      ...
      }, [["top", "left"].includes(props.presetsPlacement) ? createVNode(TExtraContent, extraProps.value, slots.presets ? {
        presets: slots.presets
      } : {}) : null, createVNode(TPanelContent, panelContentProps.value, slots), ["bottom", "right"].includes(props.presetsPlacement) ? createVNode(TExtraContent, extraProps.value, slots.presets ? {
        presets: slots.presets
      } : {}) : null]);
    };
  }
