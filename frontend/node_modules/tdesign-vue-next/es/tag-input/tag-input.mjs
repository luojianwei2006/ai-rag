...
import { u as usePrefixClass, a as useTNodeJSX, i as useGlobalIcon, e as useDisabled, o as useReadonly, k as useDefaultValue, p as useEventForward } from '../_chunks/dep-f6b5a1bf.mjs';
...
var _TagInput = defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var suffixWidthRef = ref(0);
    var suffixIconWidthRef = ref(0);
    ...
    return function () {
      ...
      var inputEvents = useEventForward(inputProps.value, {
        onWheel: onWheel,
