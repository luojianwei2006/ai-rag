...
import { useCLASSNAMES, FormInjectionKey, ValidateStatus, FormItemInjectionKey } from './constants/index.mjs';
import { a as useTNodeJSX, i as useGlobalIcon, u as usePrefixClass } from '../_chunks/dep-f6b5a1bf.mjs';
...
var _FormItem = defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var statusClasses = computed(function () {
    ...
    var innerRules = computed(function () {
      ...
      return get(form === null || form === void 0 ? void 0 : form.rules, props2.name) || [];
    });
