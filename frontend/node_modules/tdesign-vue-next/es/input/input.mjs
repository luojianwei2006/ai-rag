...
import { _ as _objectWithoutProperties } from '../_chunks/dep-0991a9a0.mjs';
...
import { i as useGlobalIcon, o as useReadonly, e as useDisabled, u as usePrefixClass, c as useCommonClassName, a as useTNodeJSX } from '../_chunks/dep-f6b5a1bf.mjs';
import './hooks/index.mjs';
import { a as getValidAttrs } from '../_chunks/dep-bf886baf.mjs';
  ...
  setup: function setup(props2, _ref) {
    ...
    return function () {
      ...
      var limitNode = limitNumber.value && props2.showLimitNumber ? createVNode("div", {
        "class": ["".concat(classPrefix.value, "-input__limit-number"), _defineProperty({}, "".concat(classPrefix.value, "-is-disabled"), isDisabled.value)]
      ...
      if (props2.type === "password") {
        var passwordClass = [_defineProperty({}, "".concat(COMPONENT_NAME.value, "__suffix-clear"), !isDisabled.value)];
      ...
      var classes = [COMPONENT_NAME.value, props2.inputClass, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, SIZE.value[props2.size], props2.size !== "medium"), STATUS.value.disabled, isDisabled.value), STATUS.value.focused, isDisabled.value ? false : focused.value), "".concat(classPrefix.value, "-is-").concat(tStatus.value), tStatus.value && tStatus.value !== "default"), "".concat(classPrefix.value, "-align-").concat(props2.align), props2.align !== "left"), "".concat(classPrefix.value, "-is-readonly"), readonly.value), "".concat(COMPONENT_NAME.value, "--prefix"), prefixIcon || labelContent), "".concat(COMPONENT_NAME.value, "--suffix"), suffixIcon || suffixContent), "".concat(COMPONENT_NAME.value, "--borderless"), props2.borderless), "".concat(COMPONENT_NAME.value, "--focused"), focused.value)];
