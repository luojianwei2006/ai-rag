...
import { u as usePrefixClass, r as useImagePreviewUrl } from '../../_chunks/dep-f6b5a1bf.mjs';
...
var TImageItem = defineComponent({
  ...
  setup: function setup(props) {
    ...
    var boxStyle = computed(function () {
      ...
      return {
        transform: "translate(".concat(translateX, "px, ").concat(translateY, "px) scale(").concat(props.scale * props.mirror, ", ").concat(props.scale, ")")
      };
    });
