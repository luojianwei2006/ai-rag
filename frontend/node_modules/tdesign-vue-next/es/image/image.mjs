...
import { o as observe } from '../_chunks/dep-6eac8050.mjs';
import { useConfig } from '../config-provider/hooks/useConfig.mjs';
import { a as useTNodeJSX, r as useImagePreviewUrl, q as useTNodeDefault } from '../_chunks/dep-f6b5a1bf.mjs';
...
var _Image = defineComponent({
  ...
  setup: function setup(props2) {
    ...
    return function () {
      ...
      }, omit(props2, ["src", "alt", "fit", "position", "shape", "placeholder", "loading", "error", "overlayTrigger", "overlayContent", "lazy", "gallery", "onLoad", "onError", "onClick"])), [renderPlaceholder(), renderGalleryShadow(), (hasError.value || !shouldLoad.value) && createVNode("div", {
