...
import { u as usePrefixClass, k as useDefaultValue, a as useTNodeJSX, e as useDisabled, o as useReadonly, p as useEventForward } from '../../_chunks/dep-f6b5a1bf.mjs';
...
function useSingle(props, context, popupRef) {
  ...
  var renderSelectSingle = function renderSelectSingle(popupVisible) {
    ...
    var inputProps = _objectSpread(_objectSpread({}, commonInputProps.value), {}, {
      ...
      suffixIcon: !isDisable.value && props.loading ? function () {
        return createVNode(Loading, {
          "loading": true,
          "size": "small"
        }, null);
      } : props.suffixIcon,
      showClearIconOnEmpty: Boolean(props.clearable && (inputValue.value || displayedValue) && !isDisable.value && !isReadonly.value)
    }, props.inputProps);
    ...
    var inputEvent = useEventForward(inputProps, {
