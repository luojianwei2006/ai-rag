...
import { _ as _asyncToGenerator, a as _regeneratorRuntime } from '../_chunks/dep-f33decbf.mjs';
...
import { d as getBackgroundColor } from '../_chunks/dep-bf886baf.mjs';
import props from './props.mjs';
import { a as useTNodeJSX, u as usePrefixClass, i as useGlobalIcon, l as useResizeObserver } from '../_chunks/dep-f6b5a1bf.mjs';
  ...
  setup: function setup(props2) {
    ...
    return function () {
      ...
      return createVNode("div", {
        ...
        "class": ["".concat(COMPONENT_NAME.value, "--thin"), "".concat(COMPONENT_NAME.value, "--status--").concat(statusStyle.value), _defineProperty({}, "".concat(classPrefix.value, "-size-s"), props2.size === "small")]
      }, [createVNode("div", {
        ...
        "class": ["".concat(COMPONENT_NAME.value, "__bar ").concat(COMPONENT_NAME.value, "--plump ").concat(separateClasses.value), _defineProperty({}, "".concat(COMPONENT_NAME.value, "--status--").concat(statusStyle.value), statusStyle.value), _defineProperty({}, "".concat(classPrefix.value, "-size-s"), props2.size === "small")],
        "style": trackBgStyle.value
      }, [createVNode("div", {
        "class": "".concat(COMPONENT_NAME.value, "__inner"),
        "ref": infoRef,
