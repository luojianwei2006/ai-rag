...
import { _ as _objectWithoutProperties } from './dep-0991a9a0.mjs';
...
var hasStyleUnit = function hasStyleUnit(value) {
  return /px|rpx|em|rem|%|vh|vw/.test(value);
};
function formatStyleUnit(value) {
  var unit = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "px";
  if (isString(value)) {
    return hasStyleUnit(value) ? value : "".concat(value).concat(unit);
  }
...
//# sourceMappingURL=dep-bf886baf.mjs.map
