...
import { h as useChildComponentSlots } from '../../_chunks/dep-f6b5a1bf.mjs';
...
var useSelectOptions = function useSelectOptions(props, keys, inputValue, innerValue) {
  ...
  var searchDisplayOptions = computed(function () {
    ...
    searchOptions.value = uniqBy([].concat(_toConsumableArray(currentSelectedOptions), _toConsumableArray(searchOptions.value)), "value");
