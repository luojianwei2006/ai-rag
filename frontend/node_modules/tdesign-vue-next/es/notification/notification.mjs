...
import { u as usePrefixClass, i as useGlobalIcon, a as useTNodeJSX, b as useContent } from '../_chunks/dep-f6b5a1bf.mjs';
...
var _Notification = defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    return function () {
      return createVNode("div", {
        "ref": notificationRef,
        "class": [COMPONENT_NAME.value, props2.className],
