...
import { T as TableTreeStore, u as useTreeDataExpand } from '../../_chunks/dep-d65fc003.mjs';
import useClassName from './useClassName.mjs';
import { renderCell } from '../components/tr.mjs';
import { i as useGlobalIcon, q as useTNodeDefault } from '../../_chunks/dep-f6b5a1bf.mjs';
...
function useTreeData(props, context) {
  ...
  watch(function () {
    var _props$tree2;
    return [columns.value, (_props$tree2 = props.tree) === null || _props$tree2 === void 0 ? void 0 : _props$tree2.treeNodeColumnIndex];
  }, function () {
