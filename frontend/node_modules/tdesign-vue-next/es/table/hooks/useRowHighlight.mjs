...
import { a as ARROW_DOWN_REG, A as ARROW_UP_REG, S as SPACE_REG, b as SHIFT_REG, c as ESCAPE_REG, d as CLEAR_REG, e as ALL_REG } from '../../_chunks/dep-8222d1c4.mjs';
  ...
  var handleInactive = function handleInactive(ctx) {
    ...
    if (activeRowType.value === "single") {
      ...
      for (var _i = 0, _len = data.value.length; _i < _len; _i++) {
        ...
        if (_newActiveRowKeys.includes(get(_row, props.rowKey))) {
          _activeRowList.push({
            row: _row,
            rowIndex: _i
          });
