...
import { k as useDefaultValue } from '../../_chunks/dep-f6b5a1bf.mjs';
import { i as isRowSelectedDisabled } from '../../_chunks/dep-3b25d7b2.mjs';
...
function useRowSelect(props, tableSelectedClasses) {
  ...
  function getSelectedHeader() {
    return function () {
      ...
      var isChecked = canSelectedRows.value.length !== 0 && intersectionKeys.value.length === canSelectedRows.value.length;
