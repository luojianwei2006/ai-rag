...
import { e as isTextEllipsis } from '../../_chunks/dep-71db8031.mjs';
  ...
  setup: function setup(props) {
    ...
    return function () {
      ...
      var rProps = _objectSpread({
        content: isOverflow.value && flag.value ? props.tooltipContent || function () {
          return cellNode;
        } : "",
        destroyOnClose: true,
        hideEmptyPopup: true,
      ...
      return createVNode(Tooltip, rProps, _isSlot(ellipsisContent) ? ellipsisContent : {
