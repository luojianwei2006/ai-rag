...
var useDrag = function useDrag(props) {
  ...
  var getCurrentWrapperSize = function getCurrentWrapperSize(e) {
    var target = e.target;
    var wrapper = target === null || target === void 0 ? void 0 : target.parentElement;
    if (!wrapper) return null;
    var isHorizontal = ["right", "left"].includes(props.placement);
    var size = isHorizontal ? wrapper.offsetWidth : wrapper.offsetHeight;
    var maxHeight = document.documentElement.clientHeight;
    var maxWidth = document.documentElement.clientWidth;
    var offsetHeight = 8;
    var offsetWidth = 8;
    var max = isHorizontal ? maxWidth : maxHeight;
    var min = isHorizontal ? offsetWidth : offsetHeight;
    ...
    var limitedSize = Math.max(limitMin, Math.min(limitMax, size));
    return "".concat(limitedSize, "px");
  };
  var enableDrag = function enableDrag(e) {
    e.stopPropagation();
    var currentSize = getCurrentWrapperSize(e);
    if (currentSize) {
  ...
  var handleMousemove = function handleMousemove(e) {
    ...
    var _getSizeDraggable2 = getSizeDraggable(props.sizeDraggable, {
        max: max,
        min: min
      }),
      allowSizeDraggable = _getSizeDraggable2.allowSizeDraggable,
      limitMax = _getSizeDraggable2.max,
      limitMin = _getSizeDraggable2.min;
