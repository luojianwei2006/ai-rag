...
import { RadioGroupInjectionKey } from './constants/index.mjs';
import { j as useVModel, u as usePrefixClass, c as useCommonClassName, l as useResizeObserver, q as useTNodeDefault } from '../_chunks/dep-f6b5a1bf.mjs';
...
var _Group = defineComponent({
  ...
  setup: function setup(props2) {
    ...
    var groupClass = computed(function () {
      return ["".concat(radioGroupName.value), SIZE.value[props2.size], _defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(radioGroupName.value, "__outline"), props2.variant === "outline"), "".concat(radioGroupName.value, "--filled"), props2.variant.includes("filled")), "".concat(radioGroupName.value, "--primary-filled"), props2.variant === "primary-filled"), "".concat(radioGroupName.value, "--vertical"), props2.direction === "vertical")];
    });
    return function () {
