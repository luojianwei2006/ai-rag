...
function useColumnController(props, context) {
  ...
  var handleToggleColumnController = function handleToggleColumnController() {
    ...
    if (columnControllerVisible.value !== void 0) {
      ...
      (_props$onColumnContro = props.onColumnControllerVisibleChange) === null || _props$onColumnContro === void 0 || _props$onColumnContro.call(props, true, {
        trigger: "open"
      });
    ...
    dialogInstance.value = DialogPlugin.confirm(_objectSpread({
      ...
      onClose: function onClose() {
        ...
        if (columnControllerVisible.value === void 0) {
          ...
          var _props$onColumnContro3;
          (_props$onColumnContro3 = props.onColumnControllerVisibleChange) === null || _props$onColumnContro3 === void 0 || _props$onColumnContro3.call(props, false, {
            trigger: "cancel"
          });
          context.emit("update:columnControllerVisible", false);
        }
  ...
  watch([columnControllerVisible], function (_ref4, _ref5) {
