...
import { g as getDefaultFormat, p as parseToDayjs } from '../../../_chunks/dep-63d7add7.js';
  ...
  setup: function setup(props, _ref) {
    ...
    var disableDateOptions = computed(function () {
      ...
      if (props.disabled && isArray(props.disabled)) {
        if (props.disabled[0]) start = startDateValue;else if (props.disabled[1]) end = endDateValue;
      }
    ...
    var rangeValue = computed(function () {
      var startRange = props.range;
      var endRange = props.range;
      if (isArray(props.range)) {
        if (props.range.length !== 2) {
          log.warn("DateRangePicker", "`range` length must be 2 when `range` is an array.");
        }
        var first = props.range[0];
        var second = props.range[1];
    ...
    return function () {
      return createVNode("div", {
        ...
        "range": rangeValue.value.start
      }, panelContentProps.value), slots), createVNode(TPanelContent, mergeProps({
        "key": "endPanel",
        "partial": "end",
        "year": props.year[1],
        "month": props.month[1],
