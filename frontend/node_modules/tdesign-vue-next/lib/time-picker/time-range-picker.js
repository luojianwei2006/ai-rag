...
import { c as customParseFormat } from '../_chunks/dep-ce5dc391.js';
import { TimeIcon } from 'tdesign-icons-vue-next';
import { RangeInputPopup } from '../range-input/index.js';
import _TimePickerPanel from './panel/time-picker-panel.js';
import { T as TIME_PICKER_EMPTY } from '../_chunks/dep-ee4c1fa4.js';
import { v as validateInputValue, f as formatInputValue } from '../_chunks/dep-ce90a4fb.js';
...
var _TimeRangePicker = defineComponent({
  ...
  setup: function setup(props2) {
    ...
    var rangeInputEvents = useEventForward(props2.rangeInputProps, {
      onClear: handleClear,
      onClick: handleClick,
      onFocus: handleFocus,
      onBlur: handleInputBlur
    });
    var popupEvents = useEventForward(props2.popupProps, {
      ...
      return createVNode("div", {
        ...
        "rangeInputProps": _objectSpread({
          ...
          suffixIcon: function suffixIcon() {
            return renderTNodeJSX("suffixIcon") || createVNode(TimeIcon$1, null, null);
          },
